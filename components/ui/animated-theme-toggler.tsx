...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "relative flex items-center justify-center p-2 rounded-full border border-current/20 transition-transform active:scale-95 cursor-pointer hover:border-current/50",
        className
      )}
      {...props}
    >
