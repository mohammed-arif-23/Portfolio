...
/**
 * @description: Liquid Glass Card & Button - Optimized with Shadcn UI & Tailwind
...
const liquidGlassCardVariants = cva(
  "group relative overflow-hidden bg-background/30 backdrop-blur-[4px] transition-all duration-300",
  {
    variants: {
      glassSize: {
        sm: "p-4",
...
// Demo: Music / Focus Audio Player Card
      ...
      {bars.map((bar) => (
        <div
          ...
          style={{
            ...
            background: "linear-gradient(to top, #00A19B, #5eead4)",
          }}
        />
      ))}
    </div>
...
const ProgressBar = React.memo(
  ({ currentTime, totalDuration, onSeek }: ProgressBarProps) => {
    ...
    return (
      <>
        <div className="flex justify-between font-mono font-medium text-xs text-zinc-500 dark:text-zinc-400">
        ...
        <div
          ...
          className="relative z-10 h-1.5 w-full cursor-pointer overflow-hidden rounded-full bg-zinc-200/80 dark:bg-zinc-800"
          onClick={handleClick}
        ...
        >
          <div
            className="h-full bg-gradient-to-r from-[#00A19B] to-[#5eead4] transition-all duration-200"
...
export function NotificationCenter() {
  ...
  return (
    <div className="w-full max-w-sm" ref={rootRef}>
      <LiquidGlassCard className="gap-3.5 rounded-3xl border border-zinc-200/60 bg-gradient-to-br from-zinc-50/80 to-zinc-100/90 p-4 shadow-xl dark:border-zinc-700/60 dark:from-zinc-900/80 dark:to-black/90">
        <div className="flex items-center gap-3">
          <div className="relative mr-2 mb-2 h-14 w-14 shrink-0 overflow-hidden rounded-2xl bg-gradient-to-br from-[#00A19B] via-teal-400 to-emerald-300 shadow-lg ring-1 ring-black/5 dark:shadow-xl flex items-center justify-center text-white font-mono font-bold text-lg">
            ⚡
          </div>

          <div className="flex-1 overflow-hidden">
            <h3 className="overflow-hidden text-ellipsis whitespace-nowrap font-semibold text-base text-zinc-900 dark:text-white">
              Creative State // Flow
            </h3>
            <p className="mt-0.5 text-xs font-mono text-[#00A19B] dark:text-teal-400">
              Mohammed Arif · System Audio
            </p>
          </div>
          ...
          <div className="mt-1 flex items-center justify-between">
            <div className="flex items-center justify-center gap-2">
              <LiquidButton
                ...
                className="h-9 w-9 rounded-full bg-transparent text-zinc-700 transition-colors hover:bg-zinc-200/80 dark:text-zinc-300 dark:hover:bg-zinc-800/80"
                size="icon"
                variant="ghost"
              >
