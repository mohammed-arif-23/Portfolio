...
const achievements = [
  {
    ...
    description:
      "1st place at national level technical symposium by KSR College of Technology",
    icon: Trophy,
    year: "2024",
  },
  {
    ...
    description:
      "1st place at national-level technical symposium by Mahendra Institutions of Technology",
    icon: Award,
    year: "2024",
  },
  {
          ...
          <FadeSlideIn duration={900} delay={100}>
            ...
            >
              <TextSplit
                ...
                duration={0.8}
              >
                Building innovative solutions and winning competitions through
                  ...
                  >
                    <Float y={5} duration={3} delay={i * 0.1}>
                      ...
                      >
                        ...
                        <h4 className="text-2xl font-bold text-white mt-8 group-hover:text-gray-300 transition-colors">
                             View Live :
                            </h4>
